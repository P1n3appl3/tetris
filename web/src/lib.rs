...
use web_sys::{Blob, ImageData, Response, js_sys::Uint8Array};
...
#[wasm_bindgen]
pub async fn fetch_url(url: String) -> Result<Blob, JsValue> {
...
pub async fn load_skin(url: String) -> Result<Skin, JsValue> {
